...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //注册 iOSSDKDemo
    [[IStationSDK sharedSDK] registerAppKey:@"dmlzaW9uZXR0ZXN0Lm9uZXN5a2VzLmNvbTowYTcxZmJhYzlkNjFlYzgwZDZlYzQ2ZDcxMzk4NDkwOQ==" appName:@"iOSSDKDemo"];
    
    //开启调试
    [[IStationSDK sharedSDK] setDebugMode];
